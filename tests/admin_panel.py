...
class TestAdminFunctionality(unittest.TestCase):
    ...
    def test_access(self):
        ...
        for page in ["dashboard", "users", "maintenance", "exploratory"]:
            ...
            response = requests.get(
                url=f"{BASE_URL}/admin/{page}", headers={"Accept": "text/html"}, timeout=TIMEOUT
            )
            ...
            response = requests.get(
                ...
                headers={"Cookie": f"djehuty_session=zz{TOKEN}", "Accept": "text/html"},
                timeout=TIMEOUT,
            )
            ...
            response = requests.get(
                url=f"{BASE_URL}/admin/{page}",
                headers={"Cookie": f"djehuty_session={TOKEN}", "Accept": "text/html"},
                timeout=TIMEOUT,
            )
            ...
            response = requests.get(
                url=f"{BASE_URL}/admin/{page}",
                headers={"Cookie": f"djehuty_session={TOKEN}", "Accept": "application/json"},
                timeout=TIMEOUT,
            )
    ...
    def test_exploratory(self):
        ...
        response = requests.get(
            ...
            params={"type": rdf.DJHT["Dataset"], "property": rdf.DJHT["container"]},
            headers={"Cookie": f"djehuty_session={TOKEN}", "Accept": "application/json"},
            timeout=TIMEOUT,
        )
