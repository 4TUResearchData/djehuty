...
Subscribe to the [4TU.ResearchData newsletter](https://m7.mailplus.nl/wpmY6EeZdyiQ-1051-370649-test-1)
for news, events, opportunities and announcements regarding `djehuty` and 4TU.ResearchData.
...
If you have questions, suggestions, or would like to contribute to the
`djehuty` project, please contact the project team via the
[GitHub repository](https://github.com/4TUResearchData/djehuty) or via email:

**Gabriela Kuhn** |
[g.kuhn@tudelft.nl](mailto:g.kuhn@tudelft.nl) |
