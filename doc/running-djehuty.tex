...
\begin{tabularx}{\textwidth}{*{1}{!{\VRule[-1pt]}l}!{\VRule[-1pt]}X}
  ...
  \t{publisher-rors}          & Mapping of publisher names to ROR URLs.
                                Each child is a
                                \t{<publisher-ror name="..." url="..."/>}
                                element. Used in RO-Crate exports and as
                                the ROR link rendered next to the publisher
                                on the dataset page when the dataset's
                                publisher matches one of the configured
                                names.\\
