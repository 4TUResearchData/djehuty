...
#wrapper { min-width: 720pt; }
#sidebar.wide { position: fixed; top: 5pt; width: 265pt; font-size: .9em; }
#sidebar.wide .likechapterHead { border-radius: 0pt 4pt 0pt 0pt; }
#sidebar.narrow { position: relative; top: auto; width: 850pt; margin-left: auto; margin-right: auto; font-size: 1.0em; background: #fff; }
#sidebar.narrow .likechapterHead { border-radius: 4pt 4pt 0pt 0pt; }
#sidebar .tableofcontents { padding: 0pt 10pt 0pt 5pt; }
#sidebar .likechapterHead { padding: 10pt; background: #aaa; color: #111; margin: 0pt; border-radius: 0pt 4pt 0pt 0pt; }
#sidebar.wide .sidebarwrap { background: #f9f9f9; border-radius: 4pt; padding-bottom: 0pt; border-right: solid 1pt #ddd; border-bottom: solid 1pt #ddd; }
...
.chapwrap .sectionHead { padding: 5pt 10pt 5pt 10pt; background: #eee; }
.chapwrap .subsectionHead { padding: 5pt 10pt 5pt 10pt; background: #f6f6f6; }
.chapwrap .likesubsubsectionHead { padding: 0pt 10pt 0pt 10pt; }
.subsubsectionHead { margin-left: .75em; font-size: 1em; }
.ectt-1095 { font-family: 'FiraMono', monospace; }
.lstlisting { font-family: 'FiraMono', monospace; font-size: 13pt; background: #f8f8f8; margin: 0pt 10pt 0pt 10pt; padding: 10pt; border-radius: 5pt; border: solid 1pt #ccc; }
...
table thead tr { background: #ff0000; }
...
window.addEventListener('load', function () {
  ...
  for (section of document.getElementsByClassName("sectionToc")) {
    ...
    if (section.nextElementSibling.className != "subsectionToc") {
