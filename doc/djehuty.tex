...
#sidebar.wide { position: fixed; top: 17pt; width: 265pt; height: 100vh; font-size: .9em; overflow-y: scroll; }
#sidebar.wide .likechapterHead { border-radius: 0pt; }
#sidebar.narrow { position: relative; top: auto; width: 850pt; margin-left: auto; margin-right: auto; font-size: 1.0em; background: #fff; }
#sidebar.narrow .likechapterHead { border-radius: 0pt; }
...
#sidebar.wide h2.additionalHead:nth-child(1) { border-radius: 0pt 4pt 0pt 0pt; }
#sidebar.narrow h2.additionalHead:nth-child(1) { border-radius: 4pt 4pt 0pt 0pt; }
#sidebar h2.additionalHead:nth-child(1) { background: #ccc; }
